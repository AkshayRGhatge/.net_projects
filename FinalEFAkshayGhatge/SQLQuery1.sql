...
delete  from Authors where AuthorID=1016;
delete  from Authors where AuthorID=1017;
delete  from Authors where AuthorID=1018;
use BooksDB;
select * from Authors;

insert into authors values('akshay','ghatge','44444','nat','bram','on');
